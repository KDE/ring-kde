...
static TypedStateMachine< const char* , Call::State > callStateIcons = {{
...
{
   connect(&CallModel::instance(),&CallModel::callStateChanged,this,&HistoryDelegate::slotStopRingingAnimation);
}
