...
m_pDnDR(nullptr),m_pDnDPix(nullptr)
{
   ...
   m_DragAndDrop = loadSvg(QStringLiteral(":/tip/icons/tips/dragAndDrop.svg"));
   loadSvg(QStandardPaths::locate(QStandardPaths::GenericDataLocation, QStringLiteral("ring-kde/tips/upArrow.svg")));
}
